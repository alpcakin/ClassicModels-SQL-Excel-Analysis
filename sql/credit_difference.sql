...
main_cte as(
	...
	on t1.customernumber = t2.customernumber and t2.paymentdate between orderdate and case when t1.next_order_date is null then current_date else next_order_date end
